...
from page_obj.company.threeD_product_page import threeDProductPage


@allure.feature("3D产品")#allure添加模块区分
class Test3DProduct:
    @allure.story("公司首页3D产品")  # allure子模块名称
    ...
    def test_Click_Back_button(self, app_page):
        ...
        threeDProductPage(app_page).Click_Back_button()
    ...
    def test_Query_product(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).Query_product(app_page)
    ...
    def test_sort(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).sort()
    ...
    def test_Collection(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).Collection()
    ...
    def test_View_product_pictures(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).View_product_pictures()
    ...
    def test_Additional_purchase(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).Additional_purchase()
    ...
    def test_add_to_cart(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).add_to_cart()
    ...
    def test_shopping_cart(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_3D_products()
        threeDProductPage(app_page).shopping_cart_button()