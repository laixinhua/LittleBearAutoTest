...
from page_obj.company.Spot_area_page import SpotAreaPage


@allure.feature("现货区")#allure添加模块区分
class TestSpotArea:
    @allure.story("公司首页现货区")  # allure子模块名称
    ...
    def test_Click_Back_button(self, app_page):
        ...
        SpotAreaPage(app_page).Click_Back_button()
    ...
    def test_Query_product(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).Query_product(app_page)
    ...
    def test_Collection(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).Collection()
    ...
    def test_View_product_pictures(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).View_product_pictures()
    ...
    def test_Additional_purchase(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).Additional_purchase()
    ...
    def test_add_to_cart(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).add_to_cart()
    ...
    def test_shopping_cart(self, app_page):
        ...
        RolePage(app_page).Select_company_role()
        CompanyHomePage(app_page).Click_the_spot_area()
        SpotAreaPage(app_page).shopping_cart_button()